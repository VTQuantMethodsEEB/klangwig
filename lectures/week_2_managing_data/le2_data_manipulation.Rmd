...
Typically, dates will be loaded in as factors. If you want them to be dates, you need to tell R this. 
...
- `spread` and `gather` have now been replaced by the more intuitive `pivot`
- These are in the notes as an example only
- We won't go through them and I encourage you to switch to `pivot`
- In the R file, go to line 44
